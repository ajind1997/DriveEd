...
public class FeedbackActivity extends AppCompatActivity {
        ...
        switch (feedbackBtn.getText().toString()){
            case "View answer":
            {
                ...
                else
                {
                   ...
                   {
                       if (select == 0){
                           answer1.setTextColor(ContextCompat.getColor(this, R.color.colorRed));
                           image1.setBackgroundResource(R.drawable.cross);
                       }
                       else if (select == 1){
                           answer2.setTextColor(ContextCompat.getColor(this, R.color.colorRed));
                           image2.setBackgroundResource(R.drawable.cross);
                       }
                       else{
                           answer3.setTextColor(ContextCompat.getColor(this, R.color.colorRed));
                           image3.setBackgroundResource(R.drawable.cross);
                       }
                ...
                if (questionCount >= numQuestions) {
                    feedbackBtn.setText("View result");
                }
                break;
            }
            case "Next question":
            ...
            case "View result":{
                Intent intent = new Intent(FeedbackActivity.this, ResultActivity.class);
    ...
    private void parseData() {
        ...
        //change the selected language below to translate
        //question and answers to selected language
